...
import API, { KeycloakAPI } from "../../API.js";
  ...
  const handleClose = (action) => {
    ...
    if (action === "Confirm") {
      if (props.isEdit) {
        ...
        responseResult = KeycloakAPI(props.data).then((res) => {
          // console.log(res);
          // return res.status === 200;
        });
      }
      ...
      props.setAlertInfo({
        ...
        message: responseResult
          ? `${props.isEdit ? "Update" : "Create"} Teacher Success!`
          : `"${props.isEdit ? "Update" : "Create"} Teacher Failed!"`,
      });
  ...
  return (
    ...
    >
      <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
        ...
        >
          {props.isEdit ? "Edit Teacher Setting" : "Create Teacher Student"}
        </strong>
