...
const columns = [
  ...
  {
    id: 2,
    fieldName: "allow_on_course",
    displayName: "Apply on",
    inputType: "text",
    xs: 12,
  },
];
    ...
    if (action === "Confirm") {
      ...
      props.setAlertInfo({
        ...
        message: responseResult
          ? `${props.isEdit ? "Update" : "Create"} Promotion Success!`
          : `"${props.isEdit ? "Update" : "Create"} Promotion Failed!"`,
      });
  ...
  return (
    ...
    >
      <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
        ...
        >
          {props.isEdit ? "Edit Promotion Setting" : "Create Promotion"}
        </strong>
